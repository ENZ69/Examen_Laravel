        ...
        <div class="page">
            ...
            <div class="content">
                ...
                <div class="container-fluid" id="sousnavbar">
                    <div class="row">
                        <div class="col-6"><i class="fa-solid fa-pen-to-square"></i> Modification d'un type</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="container col-md-6">
                        <div class="card ">
                            <div class="card-header text-center bg-secondary text-white">
                                <br>
                                <h5><i class="fa-solid fa-pen-to-square"></i> Modification du Type</h5>
                            </div>
                            <form action="{{ route('types.update', $type->id) }}" method="POST" id="mon-formulaire">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="mt-4">
                                        ...
                                        <div>
                                            <input type="text"  name="libelleType" class="form-control" id="libelleType" value="{{ old('libelleType', $type->libelleType) }}">                                        </div>
                                    </div>
                                </div>
