        ...
        <div class="page">
            ...
            <div class="content">
                ...
                <div class="container-fluid" id="sousnavbar">
                    <div class="row">
                        <div class="col-6"><i class="fa-solid fa-pen-to-square"></i> Modification d'une formation</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="container col-md-6">
                        <div class="card ">
                            <div class="card-header text-center bg-secondary text-white">
                                <br>
                                <h5><i class="fa-solid fa-pen-to-square"></i> Modification de la Formation</h5>
                            </div>
                            <form action="{{ route('formations.update', $formation->id) }}" method="POST" id="mon-formulaire">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="mt-4">
                                        ...
                                        <div>
                                            <input type="text"  name="nomFormation" class="form-control" id="nomFormation" value="{{ old('nomFormation', $formation->nomFormation) }}">                                        </div>
                                    </div>
                                    <div class="mt-4">
                                        <div>
                                        ...
                                        <div>
                                            <input type="number"  name="duree" class="form-control" id="duree" value="{{ old('duree', $formation->duree) }}">
                                        </div>
                                    </div>
                                    <div class="mt-4">
                                        <div>
                                        ...
                                        <div>
                                            <textarea id="" name="description" rows="5" cols="42" placeholder="Saisissez la description">{{ old('description', $formation->description) }}</textarea>
                                        </div>
                                    </div>
                                </div>
