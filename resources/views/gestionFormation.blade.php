        ...
        <div class="page">
            ...
            <div class="content">
                ...
                <div class="container-fluid" id="sousnavbar">
                    <div class="row">
                        <div class="col-6"><i class="fa-solid fa-gear"></i> Gestion</div>
            ...
            <div class="content-head">
                        ...
                        <tbody>
                            @foreach ($formations as $formation)
                                <tr>
                                    ...
                                    <th scope="row">{{ $formation['nomFormation'] }}</th>
                                    <th scope="row">{{ $formation['duree'] }} ans</th>
                                    <th scope="row">{{ $formation['description'] }}</th>
                                    <th>
                                        <a href="/formations/{{ $formation['id'] }}/edit" class="btn btn-info"><i class="fa-solid fa-pen"></i> Modifier</a>
                                    </th>
                                    <th>
                                        <a href="/formation/{{ $formation['id'] }}" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i> Supprimer</a>
                                    </th>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="container mt-4 col-md-5" style="border:none;">
                    ...
                    <br>
                    <form action="/gestionFormations" method="POST" id="">
                        @csrf
                        <div class="card-body">
                            <div class="mt-4">
                                <div>
                                    <label class="h6">Référentiel</label>
                                </div>
                                <div>
                                    <select name="referentiel_id" id="">
                                        <option value="">Choisir le référentiel de la formations</option>
                            ...
                            <div class="mt-4">
                                ...
                                <div>
                                    <input type="text"  name="nomFormation" class="form-control" id="nom">
                                </div>
                            </div>
                            <div class="mt-4">
                                <div>
                                    <label class="h6">Durée</label>
                                </div>
                                <div>
                                    <input type="number"  name="duree" class="form-control" id="nom">
                                </div>
                            </div>
                            <div class="mt-4">
                                <div>
                                ...
                                <div>
                                    <textarea id="" name="description" rows="5" cols="42" placeholder="Saisissez la description"></textarea>
                                </div>
                            </div>
                        </div>
