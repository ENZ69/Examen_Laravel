    ...
    <body>
        <div class="page">
            ...
            <div class="content-head">
                <div class="mt-4">
                    <div class="row">
                        <div class="col-md-6 text-center text-white" style="height:40px; padding-top:6px; font-weight:600; font-size:20px; background-color: #215856;">Formations</div>
                        <div class="col-md-6 text-center text-white" style="height:40px; padding-top:6px; font-weight:600; font-size:20px; background-color: #03968e;">Candidats</div>
                    </div>
                    <br>
                    @foreach ($formations as $formation)
                         <div class="row">
                            <div class="col-md-6 text-white" style="height:40px; padding-top:6px; font-weight:600; font-size:20px; background-color: #215856;">{{ $formation->nomFormation }} :</div>
                            <div class="col-md-6 text-center text-white" style="height:40px; padding-top:6px; font-weight:600; font-size:20px; background-color: #03968e;">{{ $formation->candidats_count }} candidats </div>
                         </div>
                         <br>
                    @endforeach
                </div>
