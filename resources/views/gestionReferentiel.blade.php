        ...
        <div class="page">
            ...
            <div class="content-head">
                        ...
                        <tbody>
                            @foreach ($referentiels as $referentiel)
                                <tr>
                                    ...
                                    <th scope="row">{{ $referentiel['libelleReferentiel'] }}</th>
                                    <th scope="row">{{ $referentiel['horaire'] }} heures</th>
                                    <th>
                                        <a href="/referentiels/{{ $referentiel['id'] }}/edit" class="btn btn-info"><i class="fa-solid fa-pen"></i> Modifier</a>
                                    </th>
                                    <th>
                                        <a href="/referentiel/{{ $referentiel['id'] }}" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i> Supprimer</a>
                                    </th>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="container mt-4 col-md-5" style="border:none;">
                    ...
                    <br>
                    <form action="/gestionReferentiels" method="POST" id="">
                        @csrf
                        <div class="card-body">
                            <div class="mt-4">
                                <div>
                                ...
                                <div>
                                    <select name="type_id" id="">
                                        <option value="">Choisir le type de formations</option>
                            ...
                            <div class="mt-4">
                                ...
                                <div>
                                    <input type="text"  name="libelleReferentiel" class="form-control" id="nom">
                                </div>
                            </div>
                            <div class="mt-4">
                                <div>
                                ...
                                <div>
                                    <input type="number"  name="horaire" class="form-control" id="nom">
                                </div>
                            </div>
                        </div>
