        ...
        <div class="page">
            ...
            <div class="content-head">
                        ...
                        <tbody>
                            @foreach ($types as $type)
                                <tr>
                                    ...
                                    <th scope="row">{{ $type['libelleType'] }}</th>
                                    <th>
                                        <a href="/types/{{ $type['id'] }}/edit" class="btn btn-info"><i class="fa-solid fa-pen"></i> Modifier</a>
                                    </th>
                                    <th>
                                        <a href="/type/{{ $type['id'] }}" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i> Supprimer</a>
                                    </th>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="container mt-4 col-md-5" style="border:none;">
                    ...
                    <br>
                    <form action="/gestion" method="POST" id="">
                        @csrf
                        <div class="card-body">
                            <div class="mt-4">
                                <div>
                                ...
                                <div>
                                    <input type="text"  name="libelleType" class="form-control" id="nom">
                                </div>
                            </div>
                        </div>
