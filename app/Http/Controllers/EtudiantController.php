...
class EtudiantController extends Controller
{
    ...
    {
        $data = DB::table('candidats')->select(DB::raw('COUNT(*) as count, CASE WHEN age BETWEEN 1 AND 10 THEN "0-10" WHEN age BETWEEN 10 AND 20 THEN "10-20" WHEN age BETWEEN 20 AND 30 THEN "20-30" ELSE "30+" END as age_group'))->groupBy('age_group')->get();
